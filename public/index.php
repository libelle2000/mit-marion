...
<div class="content">
    <header class="container-content">
        ...
        <nav class="stories closed jsFlyoutWrapper jsFlyoutHoverToggle">
            <div class="breadcrumb jsFlyoutTouchToggle jsFlyoutHoverToggle">die-fazien-fetzen und noch viel viel mehr
                und noch viel viel mehr
            </div>
            <ul class="flyout jsFlyoutHoverToggle">
                <li class="breadcrumb current jsFlyoutTouchToggle">die-fazien-fetzen und noch viel viel mehr und noch
                    viel viel mehr
                </li>
